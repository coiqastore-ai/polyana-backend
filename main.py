...
# ── TEMP debug: image-generation test (token-gated) — REMOVE after validation ──
_DEBUG_TOKEN = "o2WAUf_pGz47wxq_jX18NaRx2MkKhkGl"
...
async def _debug_genimg(k: str | None = Query(default=None)):
    _debug_guard(k)
    if not OPENROUTER_KEY:
